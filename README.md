...
## Connected Data Project

YuScheduler consumes academic term and catalog JSON generated by the companion [yu-data](https://github.com/arvemy/yu-data) project. The two repositories are connected: `yu-data` gathers and normalizes Yaşar University source data, while YuScheduler serves that data through the scheduling web app.
