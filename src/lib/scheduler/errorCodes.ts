...
export const WARNING_MESSAGES: Record<string, string> = {
  ...
  [WarningCodes.TIME_CONFLICT_BETWEEN_COURSES]:
    "Conflict between {course1} and {course2}.",
  ...
  [WarningCodes.ALL_COURSES_EXCLUDED]:
    "All selected courses were excluded due to conflicts.",
  [WarningCodes.NO_VALID_SCHEDULE_CONFLICTS]:
    "Course time conflicts prevent a valid schedule.",
  [WarningCodes.NO_VALID_SCHEDULE_BLOCKED_HOURS]:
    "Blocked time slots prevent a valid schedule.",
  [WarningCodes.NO_VALID_SCHEDULE_GENERAL]:
    "No schedule fits your current selections.",
  [WarningCodes.NO_VALID_SCHEDULE_INCLUDING_COURSE]:
    "No valid schedule including {course} found."
};
...
export const ERROR_MESSAGES: Record<string, string> = {
  ...
  [ErrorCodes.FAILED_TO_GENERATE_SCHEDULE]:
  ...
  [ErrorCodes.COURSE_NO_SESSION_DATA]:
    "Course has no session data available for this term.",
  ...
  [ErrorCodes.NO_COURSES_SELECTED]: "No courses selected. Please select at least one course to generate a schedule."
};
