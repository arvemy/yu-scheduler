...
export const DOWNLOAD_FOOTER_HEIGHT = 48;
export const DOWNLOAD_FOOTER_PADDING = 16;
export const DOWNLOAD_FOOTER_FONT =
	"500 14px 'Inter Variable', Inter, Helvetica, Arial, sans-serif";
